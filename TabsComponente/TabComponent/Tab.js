  ...
  static InicializarTabs(){
    ...
    tabs.forEach((tab, indice) => {
        tab.addEventListener("click", () => {
          ...
          contenidos[indice].style.display = "grid"
...
const tab1 = new Tab(50, document.querySelector(".tab-container"), "Opción 1")
const tab2 = new Tab(50, document.querySelector(".tab-container"), "Opción 2")
// const tab3 = new Tab(25, document.querySelector(".tab-container"), "Opción 3")
// const tab4 = new Tab(25, document.querySelector(".tab-container"), "Opción 4")
